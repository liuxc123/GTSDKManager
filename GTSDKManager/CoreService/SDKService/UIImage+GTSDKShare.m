...
@implementation UIImage (GTSDKShare)

// Returns a rescaled copy of the image, taking into account its orientation
// The image will be scaled disproportionately if necessary to fit the bounds specified by the
// parameter
- (UIImage *)GTSDKShare_resizedImage:(CGSize)newSize interpolationQuality:(CGInterpolationQuality)quality
{
    BOOL drawTransposed;
    ...
    return [self GTSDKShare_resizedImage:newSize
                               transform:[self GTSDKShare_transformForOrientation:newSize]
...
// image
- (CGAffineTransform)GTSDKShare_transformForOrientation:(CGSize)newSize
{
