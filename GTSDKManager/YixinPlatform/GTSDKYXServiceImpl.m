//
//  GTSDKYXServiceImpl.m
//  FBSnapshotTestCase
//
//  Created by liuxc on 2018/11/15.
//

#import "GTSDKYXServiceImpl.h"
#import "YXApi.h"
#import "UIImage+GTSDKShare.h"

@interface GTSDKYXServiceImpl () <YXApiDelegate>

@property (nonatomic, copy) NSString *yxAppid;
@property (nonatomic, copy) NSString *yxAppSecret;
@property (nonatomic, copy) GTSDKYXCallbackBlock callbackBlock;

@end

@implementation GTSDKYXServiceImpl


+ (instancetype)sharedService
{
    static GTSDKYXServiceImpl *sharedInstance = nil;
...
- (void)registerWithPlatformConfig:(NSDictionary *)config
{
    ...
    NSString *yxAppId = config[GTSDKConfigAppIdKey];
...
- (BOOL)sendReq:(YXBaseReq *)req callback:(GTSDKYXCallbackBlock)callbackBlock
{
